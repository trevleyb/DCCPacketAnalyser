...
public class FunctionsMessage (IPacketMessage packet) : PacketMessage(packet.PacketData, packet.AddressType, packet.Address) {
    
    public FunctionsGroupEnum FunctionsGroup { get; set; }
    ...
    public override string ToString() {
        return $"FUNCTION: Address={Address} \t[{PacketData.ToBinary}]";
    }
